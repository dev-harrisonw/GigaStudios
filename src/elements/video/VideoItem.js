...
function VideoItem({ galleryItem }) {
    ...
    return (
        <div className="rn-gallery icon-center video-gallery-content bg_image" data-black-overlay="7" style={{ backgroundImage: `url(${process.env.NEXT_PUBLIC_URL}/images/bg/bg-image-4.jpg)` }}>
