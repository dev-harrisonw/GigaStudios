                        ...
                        <div className="row align-items-center">
                            <div className="col-lg-7 col-xl-6 order-2 order-lg-1 mt_md--40 mt_sm--40">
                                <div className="inner text-start">
                                    ...
                                    <h1 className="title theme-gradient display-one">GigaStudios Company.</h1>
                                    ...
                                    <div className="button-group mt--40">
                                        <a className="btn-default btn-medium round btn-icon" target="_blank" href="https://calendly.com/gigastudios/30min?month=2023-02">Purchase Now <i className="icon"><FiArrowRight /></i></a>
